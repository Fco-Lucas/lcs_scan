...
public class SystemUserUpdatePasswordDto {
    ...
    public SystemUserUpdatePasswordDto() {
    }

    public SystemUserUpdatePasswordDto(String currentPassword, String newPassword, String confirmNewPassword) {
    ...
    public String toString() {
        return "SystemUserUpdatePasswordDto{" +
